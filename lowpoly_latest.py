...
from scene_simplification_settings import *
...
#BALL: (89,69,4,255)
#RED: (0,0,255,255)#red
#BLUE: (255,0,00,255)#blue
#GREEN: (0,255,00,255)#green
#PINK: (255,200,255,255),#pink
color_assignmentNEW = {
    0: (255,0,255,255),#background (purple)
    1: (255,200,255,255),#pink
    2: (0,0,255,255),#red
    3: (0,255,00,255),#green
    4: (255,0,00,255),#blue
    5: (0,0,255,255),#red
    6: (0,255,00,255),#green
    7: (255,0,00,255),#blue
    8: (0,0,255,255),#red
    9: (0,255,00,255),#green
    10: (121,141,205,255),#skin
    11: (121,141,205,255),#glasses
    12: (200,200,200,255),#shirt
    13: (34,34,34,255),#trousers
    14: (49,32,46,255),#jersey
...
#TODO: find a better way to avoid wrong facial traits (check contours or something)
no_face_list = ["252.png", "253.png", "254.png", "255.png", "259.png", "266.png", "267.png", "280.png", "281.png"]
'''
...
def lowpoly_scene(SCENE_PATH, addFace, shadowSize):
    ...
    for filename in sorted(os.listdir(inputpath)):
        if filename.lower().endswith(('.png', '.jpg', '.jpeg', '.tiff', '.bmp', '.gif')):# and filename=="00066.png":
            ...
            #draw face elements
            if addFace and filename not in no_face_list:
...
if __name__ == "__main__":
    ...
    lowpoly_scene(SCENE_PATH, addFace, shadowSize)                